...
namespace PochtaSdk.Tests
{
    ...
    public class TariffSerializationTests
    {
        ...
        {
            // no null values
            var orderJson = "{\"address-type-to\":\"DEFAULT\",\"given-name" +
                "\":\"Иван\",\"house-to\":\"1\",\"mail-category\":\"ORDINA" +
                "RY\",\"mail-direct\":643,\"mail-type\":\"POSTAL_PARCEL\"," +
                "\"mass\":1234,\"middle-name\":\"Иванович\",\"order-num\":" +
                "\"тест 111\",\"index-to\":117463,\"place-to\":\"Москва\"," +
